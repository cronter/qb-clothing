...
Config.Stores = {
	...
	[2] =   {shopType = "clothing", coords = vector3(-1192.94495, -772.688965, 17.3255997)},
	[3] =   {shopType = "clothing", coords = vector3( 425.236, -806.008, 28.491)},
	[4] =   {shopType = "clothing", coords = vector3(-162.658, -303.397, 38.733)},
	[5] =   {shopType = "clothing", coords = vector3(75.950, -1392.891, 28.376)},
	[6] =   {shopType = "clothing", coords = vector3(-822.194, -1074.134, 10.328)},
	[7] =   {shopType = "clothing", coords = vector3(-1450.711, -236.83, 48.809)},
	[8] =   {shopType = "clothing", coords = vector3(4.254, 6512.813, 30.877)},
	[9] =  {shopType = "clothing", coords = vector3(615.180, 2762.933, 41.088)},
	[10] =  {shopType = "clothing", coords = vector3(1196.785, 2709.558, 37.222)},
	[11] =  {shopType = "clothing", coords = vector3(-3171.453, 1043.857, 19.863)},
	[12] =  {shopType = "clothing", coords = vector3(-1100.959, 2710.211, 18.107)},
	[13] =  {shopType = "clothing", coords = vector3(-1207.65, -1456.88, 4.3784737586975)},
    [14] =  {shopType = "clothing", coords = vector3(121.76, -224.6, 53.56)},
	[15] =  {shopType = "barber",  coords = vector3(-814.3, -183.8, 36.6)},
	[16] =  {shopType = "barber",  coords = vector3(136.8, -1708.4, 28.3)},
	[17] =  {shopType = "barber",  coords = vector3(-1282.6, -1116.8, 6.0)},
...
Config.ClothingRooms = {
    [1] = {requiredJob = "police", coords = vector3(362.28842163086, -1591.4627685547, 25.451536178589), cameraLocation = vector4(362.28842163086, -1591.4627685547, 25.451536178589, 359.725685119629)},
    [2] = {requiredJob = "ambulance", coords = vector3(313.86, -1408.58, 32.51), cameraLocation = vector4(312.08, -1410.72, 32.51, 320.91)},
}
        ...
        ["male"] = {
            [1] = {
                ...
                outfitData = {
                    ...
                    ["torso2"]      = { item = 382, texture = 12},  -- Jas / Vesten
                    ["shoes"]       = { item = 51, texture = 0},  -- Schoenen
                    -- ["decals"]      = { item = 7, texture = 0},  -- Decals
                    --["accessory"]   = { item = 148, texture = 0},  -- Nek / Das
                    ["bag"]         = { item = 100, texture = 0},  -- Tas
			...
			[2] = {
                ...
                outfitData = {
                    ...
                    ["t-shirt"]     = { item = 58, texture = 0},  -- T Shirt
                    --["vest"]        = { item = 27, texture = 0},  -- Body Vest
                    ["torso2"]      = { item = 382, texture = 13},  -- Jas / Vesten
                    ["shoes"]       = { item = 51, texture = 0},  -- Schoenen
                    -- ["decals"]      = { item = 7, texture = 0},  -- Decals
                    --["accessory"]   = { item = 148, texture = 0},  -- Nek / Das
                    ["bag"]         = { item = 100, texture = 1},  -- Tas
                    --["hat"]         = { item = -1, texture = -1},  -- Pet
                    --["glass"]       = { item = 0, texture = 0},  -- Bril
            --      ["ear"]         = { item = 0, texture = 0},  -- Oor accessoires
                    --["mask"]         = { item = 141, texture = 0},  -- Masker
			...
			[3] = {
                ...
                outfitData = {
                    ...
                    ["t-shirt"]     = { item = 58, texture = 0},  -- T Shirt
                    --["vest"]        = { item = 27, texture = 0},  -- Body Vest
                    ["torso2"]      = { item = 382, texture = 14},  -- Jas / Vesten
                    ["shoes"]       = { item = 51, texture = 0},  -- Schoenen
                    -- ["decals"]      = { item = 7, texture = 0},  -- Decals
                    --["accessory"]   = { item = 148, texture = 0},  -- Nek / Das
                    ["bag"]         = { item = 100, texture = 2},  -- Tas
                    --["hat"]         = { item = -1, texture = -1},  -- Pet
                    --["glass"]       = { item = 0, texture = 0},  -- Bril
            --      ["ear"]         = { item = 0, texture = 0},  -- Oor accessoires
                    --["mask"]         = { item = 141, texture = 0},  -- Masker
			...
			[4] = {
                ...
                outfitData = {
                    ...
                    ["t-shirt"]     = { item = 58, texture = 0},  -- T Shirt
                    --["vest"]        = { item = 27, texture = 0},  -- Body Vest
                    ["torso2"]      = { item = 382, texture = 15},  -- Jas / Vesten
                    ["shoes"]       = { item = 51, texture = 0},  -- Schoenen
                    -- ["decals"]      = { item = 7, texture = 0},  -- Decals
                    --["accessory"]   = { item = 148, texture = 0},  -- Nek / Das
                    ["bag"]         = { item = 100, texture = 3},  -- Tas
                    --["hat"]         = { item = -1, texture = -1},  -- Pet
                    --["glass"]       = { item = 0, texture = 0},  -- Bril
            --      ["ear"]         = { item = 0, texture = 0},  -- Oor accessoires
                    --["mask"]         = { item = 141, texture = 0},  -- Masker
			...
			[5] = {
                ...
                outfitData = {
                    ...
                    ["t-shirt"]     = { item = 58, texture = 0},  -- T Shirt
                    --["vest"]        = { item = 27, texture = 0},  -- Body Vest
                    ["torso2"]      = { item = 382, texture = 16},  -- Jas / Vesten
                    ["shoes"]       = { item = 51, texture = 0},  -- Schoenen
                    -- ["decals"]      = { item = 7, texture = 0},  -- Decals
                    --["accessory"]   = { item = 148, texture = 0},  -- Nek / Das
                    ["bag"]         = { item = 100, texture = 4},  -- Tas
                    --["hat"]         = { item = -1, texture = -1},  -- Pet
                    --["glass"]       = { item = 0, texture = 0},  -- Bril
            --      ["ear"]         = { item = 0, texture = 0},  -- Oor accessoires
                    --["mask"]         = { item = 141, texture = 0},  -- Masker
    ...
    ["ambulance"] = {
        ["male"] = {
            [1] = {
                outfitLabel = "EMS",
                outfitData = {
                    ["pants"]       = { item = 129,texture = 0},  -- Broek
        ...
        ["female"] = {
            [1] = {
                ...
                outfitData = {
                    ...
                    ["t-shirt"]     = { item = 189, texture = 0},  -- T Shirt
                    --["vest"]        = { item = 20, texture = 0},  -- VEST
                    ["torso2"]      = { item = 258, texture = 1},  -- JACKET
                    ["shoes"]       = { item = 25, texture = 0},  -- SHOES
                    -- ["decals"]      = { item = 0, texture = 0},  -- Decals
                    ["accessory"]   = { item = 96, texture = 0},  -- Neck
                    ["bag"]         = { item = 81, texture = 20},  -- BAG
